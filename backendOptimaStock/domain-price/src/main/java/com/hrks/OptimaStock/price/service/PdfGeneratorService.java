...
public class PdfGeneratorService {
        ...
        /**
         * Versión asíncrona para generar PDF (No bloquea el hilo principal HTTP)
         */
        @org.springframework.scheduling.annotation.Async("taskExecutor")
        public java.util.concurrent.CompletableFuture<byte[]> generateQuotePdfAsync(Quote quote) {
                try {
                        return java.util.concurrent.CompletableFuture.completedFuture(generateQuotePdf(quote));
                } catch (IOException e) {
